...
<a href="?view=detalles&id='.$id_modeloporid.'"><img src="'.CARP_IMG.$_modelosporid[$id_modeloporid]['IMA_PROD'].'" title="Adamant an Industrial Category Flat Bootstrap Responsive Web Template" alt="Adamant an Industrial Category Flat Bootstrap
